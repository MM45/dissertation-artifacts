...
module M(SC:Syscall_t) = {
  ...
  proc bytes_n__ull_to_bytes (out:W8.t Array32.t, in_0:W64.t) : W8.t Array32.t = {
    var inc:int;
    var i:int;
    in_0 <- in_0;
    inc <- (- 1);
  ...
  proc bytes_pad__ull_to_bytes (out:W8.t Array32.t, in_0:W64.t) : W8.t Array32.t = {
    var inc:int;
    var i:int;
    in_0 <- in_0;
    inc <- (- 1);
  ...
  proc bytes_32__ull_to_bytes (out:W8.t Array32.t, in_0:W64.t) : W8.t Array32.t = {
    var inc:int;
    var i:int;
    in_0 <- in_0;
    inc <- (- 1);
  ...
  proc bytes_idx__ull_to_bytes (out:W8.t Array3.t, in_0:W64.t) : W8.t Array3.t = {
    var inc:int;
    var i:int;
    in_0 <- in_0;
    inc <- (- 1);
  ...
  proc bytes_wots_checksum__ull_to_bytes (out:W8.t Array2.t, in_0:W64.t) : 
  W8.t Array2.t = {
    var inc:int;
    var i:int;
    in_0 <- in_0;
  ...
  proc __memset_zero_u8 (a:W8.t Array3.t) : W8.t Array3.t = {
    ...
    if ((3 = 4)) {
      ...
      (Array3.init
      (WArray3.get8
      (WArray3.set32 (WArray3.init8 (fun i_0 => a.[i_0])) 0 (W32.of_int 0))));
    } else {
      if ((3 = 8)) {
        a <-
        (Array3.init
        (WArray3.get8
        (WArray3.set64 (WArray3.init8 (fun i_0 => a.[i_0])) 0 (W64.of_int 0))
        ));
      } else {
        i <- (W64.of_int 0);
        while ((i \ult (W64.of_int 3))) {
  ...
  proc memset_idx_bytes____memset_u8 (a:W8.t Array3.t, value:W8.t) : 
  W8.t Array3.t = {
    var i:W64.t;
    i <- (W64.of_int 0);
    while ((i \ult (W64.of_int 3))) {
  ...
  proc memset_i____memset_u8 (a:W8.t Array128.t, value:W8.t) : W8.t Array128.t = {
    var i:W64.t;
    i <- (W64.of_int 0);
    while ((i \ult (W64.of_int (131 - 3)))) {
      a.[(W64.to_uint i)] <- value;
      i <- (i + (W64.of_int 1));
    }
    return a;
  ...
  proc __memcpy_u8u8p (out:W8.t Array32.t, in_ptr:W64.t) : W8.t Array32.t = {
    ...
    while ((i < 4)) {
      ...
      (Array32.init
      (WArray32.get8
      (WArray32.set64_direct (WArray32.init8 (fun i_0 => out.[i_0])) 
      (i * 8)
      (loadW64 Glob.mem (W64.to_uint (in_ptr + (W64.of_int (8 * i))))))));
      i <- (i + 1);
    }
    return out;
  }
  ...
  proc __nbytes_copy_inplace (out:W8.t Array2144.t, offset_out:W64.t,
  ...
  proc memcpy_u8pu8_n____memcpy_u8pu8 (out:W64.t, offset:W64.t,
                                       in_0:W8.t Array32.t) : W64.t = {
    var i:W64.t;
    var i_0:int;
    if ((32 = 32)) {
      i_0 <- 0;
      while ((i_0 < 4)) {
        Glob.mem <-
        (storeW64 Glob.mem (W64.to_uint (out + offset))
        (get64 (WArray32.init8 (fun i_1 => in_0.[i_1])) i_0));
  ...
  proc memcpy_u8pu8_n___memcpy_u8pu8 (out:W64.t, offset:W64.t,
                                      in_0:W8.t Array32.t) : W64.t = {
    
    out <@ memcpy_u8pu8_n____memcpy_u8pu8 (out, offset, in_0);
    return out;
  }
  proc memcpy_u8pu8_n___x_memcpy_u8pu8 (out:W64.t, _offset:int,
                                        in_0:W8.t Array32.t) : W64.t = {
    var offset:W64.t;
    offset <- (W64.of_int _offset);
    out <- out;
    in_0 <- in_0;
    out <@ memcpy_u8pu8_n___memcpy_u8pu8 (out, offset, in_0);
    out <- out;
    return out;
  }
  proc memcpy_u8u8_N____nbytes_copy_offset (out:W8.t Array32.t,
                                            offset_out:W64.t,
                                            in_0:W8.t Array32.t,
                                            offset_in:W64.t) : W8.t Array32.t = {
    var i:int;
    i <- 0;
    while ((i < 32)) {
      out.[(W64.to_uint (offset_out + (W64.of_int i)))] <-
  ...
  proc memcpy_u8u8_N____memcpy_u8u8 (out:W8.t Array32.t, in_0:W8.t Array32.t) : 
  W8.t Array32.t = {
    var i:W64.t;
    i <- (W64.of_int 0);
    while ((i \ult (W64.of_int 32))) {
  ...
  proc memcpy_u8u8_N___memcpy_u8u8 (out:W8.t Array32.t, in_0:W8.t Array32.t) : 
  W8.t Array32.t = {
    
    out <@ memcpy_u8u8_N____memcpy_u8u8 (out, in_0);
    return out;
  }
  proc memcpy_u8u8_N___x_memcpy_u8u8 (out:W8.t Array32.t, in_0:W8.t Array32.t) : 
  W8.t Array32.t = {
    
    out <- out;
    in_0 <- in_0;
    out <@ memcpy_u8u8_N___memcpy_u8u8 (out, in_0);
    out <- out;
    return out;
  }
  proc memcpy_u8u8_N____memcpy_u8u8_2 (out:W8.t Array32.t,
                                       in_0:W8.t Array32.t, in_offset:W64.t,
                                       bytes:W64.t) : W8.t Array32.t * W64.t = {
    var i:W64.t;
    i <- (W64.of_int 0);
    while ((i \ult bytes)) {
  ...
  proc memcpy_u8u8_N____memcpy_u8u8_3 (out:W8.t Array32.t,
                                       in_0:W8.t Array32.t, out_offset:W64.t,
                                       bytes:int) : W8.t Array32.t = {
    var inc:int;
    var i:int;
    inc <- bytes;
    i <- 0;
  ...
  proc memcpy_u8u8_2N____nbytes_copy_offset (out:W8.t Array64.t,
                                             offset_out:W64.t,
                                             in_0:W8.t Array64.t,
                                             offset_in:W64.t) : W8.t Array64.t = {
    var i:int;
    i <- 0;
    while ((i < 32)) {
      out.[(W64.to_uint (offset_out + (W64.of_int i)))] <-
  ...
  proc memcpy_u8u8_2N____memcpy_u8u8 (out:W8.t Array64.t, in_0:W8.t Array64.t) : 
  W8.t Array64.t = {
    var i:W64.t;
    i <- (W64.of_int 0);
  ...
  proc memcpy_u8u8_2N___memcpy_u8u8 (out:W8.t Array64.t, in_0:W8.t Array64.t) : 
  W8.t Array64.t = {
    
    out <@ memcpy_u8u8_2N____memcpy_u8u8 (out, in_0);
    return out;
  }
  proc memcpy_u8u8_2N___x_memcpy_u8u8 (out:W8.t Array64.t,
                                       in_0:W8.t Array64.t) : W8.t Array64.t = {
    
    out <- out;
    in_0 <- in_0;
    out <@ memcpy_u8u8_2N___memcpy_u8u8 (out, in_0);
    out <- out;
    return out;
  }
  proc memcpy_u8u8_2N____memcpy_u8u8_2 (out:W8.t Array64.t,
                                        in_0:W8.t Array64.t, in_offset:W64.t,
                                        bytes:W64.t) : W8.t Array64.t * W64.t = {
    var i:W64.t;
    i <- (W64.of_int 0);
    while ((i \ult bytes)) {
      out.[(W64.to_uint i)] <- in_0.[(W64.to_uint in_offset)];
  ...
  proc memcpy_u8u8_2N____memcpy_u8u8_3 (out:W8.t Array64.t,
                                        in_0:W8.t Array64.t,
                                        out_offset:W64.t, bytes:int) : 
  W8.t Array64.t = {
    var inc:int;
    var i:int;
    inc <- bytes;
  ...
  proc memcpy_u8u8_2N_N____nbytes_copy_offset (out:W8.t Array64.t,
                                               offset_out:W64.t,
                                               in_0:W8.t Array32.t,
                                               offset_in:W64.t) : W8.t Array64.t = {
    var i:int;
  ...
  proc memcpy_u8u8_2N_N____memcpy_u8u8 (out:W8.t Array64.t,
                                        in_0:W8.t Array32.t) : W8.t Array64.t = {
    var i:W64.t;
    i <- (W64.of_int 0);
    while ((i \ult (W64.of_int 32))) {
      out.[(W64.to_uint i)] <- in_0.[(W64.to_uint i)];
  ...
  proc memcpy_u8u8_2N_N___memcpy_u8u8 (out:W8.t Array64.t,
                                       in_0:W8.t Array32.t) : W8.t Array64.t = {
    
    out <@ memcpy_u8u8_2N_N____memcpy_u8u8 (out, in_0);
    return out;
  }
  proc memcpy_u8u8_2N_N___x_memcpy_u8u8 (out:W8.t Array64.t,
                                         in_0:W8.t Array32.t) : W8.t Array64.t = {
    
    out <- out;
    in_0 <- in_0;
    out <@ memcpy_u8u8_2N_N___memcpy_u8u8 (out, in_0);
    out <- out;
    return out;
  }
  proc memcpy_u8u8_2N_N____memcpy_u8u8_2 (out:W8.t Array64.t,
                                          in_0:W8.t Array32.t,
                                          in_offset:W64.t, bytes:W64.t) : 
  ...
  proc memcpy_u8u8_2N_N____memcpy_u8u8_3 (out:W8.t Array64.t,
                                          in_0:W8.t Array32.t,
                                          out_offset:W64.t, bytes:int) : 
  W8.t Array64.t = {
    var inc:int;
  ...
  proc memcpy_u8pu8_plen____memcpy_u8pu8 (out:W64.t, offset:W64.t,
                                          in_0:W8.t Array32.t) : W64.t = {
    var i:W64.t;
    var i_0:int;
    if ((32 = 32)) {
  ...
  proc memcpy_u8pu8_plen___memcpy_u8pu8 (out:W64.t, offset:W64.t,
                                         in_0:W8.t Array32.t) : W64.t = {
    
    out <@ memcpy_u8pu8_plen____memcpy_u8pu8 (out, offset, in_0);
    return out;
  }
  proc memcpy_u8pu8_plen___x_memcpy_u8pu8 (out:W64.t, _offset:int,
                                           in_0:W8.t Array32.t) : W64.t = {
    var offset:W64.t;
    offset <- (W64.of_int _offset);
    out <- out;
    in_0 <- in_0;
    out <@ memcpy_u8pu8_plen___memcpy_u8pu8 (out, offset, in_0);
    out <- out;
    return out;
  }
  proc memcpy_u8u8_2_ltree____nbytes_copy_offset (out:W8.t Array64.t,
                                                  offset_out:W64.t,
                                                  in_0:W8.t Array2144.t,
                                                  offset_in:W64.t) : 
  W8.t Array64.t = {
    var i:int;
    i <- 0;
  ...
  proc memcpy_u8u8_2_ltree____memcpy_u8u8 (out:W8.t Array64.t,
                                           in_0:W8.t Array2144.t) : W8.t Array64.t = {
    var i:W64.t;
    i <- (W64.of_int 0);
    while ((i \ult (W64.of_int 2144))) {
      out.[(W64.to_uint i)] <- in_0.[(W64.to_uint i)];
      i <- (i + (W64.of_int 1));
    }
    return out;
  }
  proc memcpy_u8u8_2_ltree___memcpy_u8u8 (out:W8.t Array64.t,
                                          in_0:W8.t Array2144.t) : W8.t Array64.t = {
    
    out <@ memcpy_u8u8_2_ltree____memcpy_u8u8 (out, in_0);
    return out;
  }
  proc memcpy_u8u8_2_ltree___x_memcpy_u8u8 (out:W8.t Array64.t,
                                            in_0:W8.t Array2144.t) : 
  W8.t Array64.t = {
    
    out <- out;
    in_0 <- in_0;
    out <@ memcpy_u8u8_2_ltree___memcpy_u8u8 (out, in_0);
    out <- out;
    return out;
  }
  proc memcpy_u8u8_2_ltree____memcpy_u8u8_2 (out:W8.t Array64.t,
                                             in_0:W8.t Array2144.t,
                                             in_offset:W64.t, bytes:W64.t) : 
  W8.t Array64.t * W64.t = {
    var i:W64.t;
  ...
  proc memcpy_u8u8_2_ltree____memcpy_u8u8_3 (out:W8.t Array64.t,
                                             in_0:W8.t Array2144.t,
                                             out_offset:W64.t, bytes:int) : 
  W8.t Array64.t = {
    var inc:int;
  ...
  proc memcpy_u8u8_3_treehash____nbytes_copy_offset (out:W8.t Array352.t,
                                                     offset_out:W64.t,
                                                     in_0:W8.t Array32.t,
                                                     offset_in:W64.t) : 
  W8.t Array352.t = {
  ...
  proc memcpy_u8u8_3_treehash____memcpy_u8u8 (out:W8.t Array352.t,
                                              in_0:W8.t Array32.t) : 
  W8.t Array352.t = {
    var i:W64.t;
    i <- (W64.of_int 0);
  ...
  proc memcpy_u8u8_3_treehash___memcpy_u8u8 (out:W8.t Array352.t,
                                             in_0:W8.t Array32.t) : W8.t Array352.t = {
    
    out <@ memcpy_u8u8_3_treehash____memcpy_u8u8 (out, in_0);
    return out;
  }
  proc memcpy_u8u8_3_treehash___x_memcpy_u8u8 (out:W8.t Array352.t,
                                               in_0:W8.t Array32.t) : 
  W8.t Array352.t = {
    
    out <- out;
    in_0 <- in_0;
    out <@ memcpy_u8u8_3_treehash___memcpy_u8u8 (out, in_0);
    out <- out;
    return out;
  }
  proc memcpy_u8u8_3_treehash____memcpy_u8u8_2 (out:W8.t Array352.t,
                                                in_0:W8.t Array32.t,
                                                in_offset:W64.t, bytes:W64.t) : 
  W8.t Array352.t * W64.t = {
    var i:W64.t;
    i <- (W64.of_int 0);
    while ((i \ult bytes)) {
      out.[(W64.to_uint i)] <- in_0.[(W64.to_uint in_offset)];
  ...
  proc memcpy_u8u8_3_treehash____memcpy_u8u8_3 (out:W8.t Array352.t,
                                                in_0:W8.t Array32.t,
                                                out_offset:W64.t, bytes:int) : 
  W8.t Array352.t = {
    var inc:int;
  ...
  proc memcpy_u8u8_2_treehash____nbytes_copy_offset (out:W8.t Array64.t,
                                                     offset_out:W64.t,
                                                     in_0:W8.t Array352.t,
                                                     offset_in:W64.t) : 
  W8.t Array64.t = {
    var i:int;
    i <- 0;
  ...
  proc memcpy_u8u8_2_treehash____memcpy_u8u8 (out:W8.t Array64.t,
                                              in_0:W8.t Array352.t) : 
  W8.t Array64.t = {
    var i:W64.t;
    i <- (W64.of_int 0);
    while ((i \ult (W64.of_int ((10 + 1) * 32)))) {
      out.[(W64.to_uint i)] <- in_0.[(W64.to_uint i)];
      i <- (i + (W64.of_int 1));
    }
    return out;
  }
  proc memcpy_u8u8_2_treehash___memcpy_u8u8 (out:W8.t Array64.t,
                                             in_0:W8.t Array352.t) : 
  W8.t Array64.t = {
    
    out <@ memcpy_u8u8_2_treehash____memcpy_u8u8 (out, in_0);
    return out;
  }
  proc memcpy_u8u8_2_treehash___x_memcpy_u8u8 (out:W8.t Array64.t,
                                               in_0:W8.t Array352.t) : 
  W8.t Array64.t = {
    
    out <- out;
    in_0 <- in_0;
    out <@ memcpy_u8u8_2_treehash___memcpy_u8u8 (out, in_0);
    out <- out;
    return out;
  }
  proc memcpy_u8u8_2_treehash____memcpy_u8u8_2 (out:W8.t Array64.t,
                                                in_0:W8.t Array352.t,
                                                in_offset:W64.t, bytes:W64.t) : 
  W8.t Array64.t * W64.t = {
    var i:W64.t;
  ...
  proc memcpy_u8u8_2_treehash____memcpy_u8u8_3 (out:W8.t Array64.t,
                                                in_0:W8.t Array352.t,
                                                out_offset:W64.t, bytes:int) : 
  W8.t Array64.t = {
    var inc:int;
  ...
  proc nbytes_copy_offset_pk____nbytes_copy_offset (out:W8.t Array64.t,
                                                    offset_out:W64.t,
                                                    in_0:W8.t Array32.t,
                                                    offset_in:W64.t) : 
  W8.t Array64.t = {
  ...
  proc nbytes_copy_offset_pk____memcpy_u8u8 (out:W8.t Array64.t,
                                             in_0:W8.t Array32.t) : W8.t Array64.t = {
    var i:W64.t;
    i <- (W64.of_int 0);
    while ((i \ult (W64.of_int 32))) {
  ...
  proc nbytes_copy_offset_pk___memcpy_u8u8 (out:W8.t Array64.t,
                                            in_0:W8.t Array32.t) : W8.t Array64.t = {
    
    out <@ nbytes_copy_offset_pk____memcpy_u8u8 (out, in_0);
    return out;
  }
  proc nbytes_copy_offset_pk___x_memcpy_u8u8 (out:W8.t Array64.t,
                                              in_0:W8.t Array32.t) : 
  W8.t Array64.t = {
    
    out <- out;
    in_0 <- in_0;
    out <@ nbytes_copy_offset_pk___memcpy_u8u8 (out, in_0);
    out <- out;
    return out;
  }
  proc nbytes_copy_offset_pk____memcpy_u8u8_2 (out:W8.t Array64.t,
                                               in_0:W8.t Array32.t,
                                               in_offset:W64.t, bytes:W64.t) : 
  W8.t Array64.t * W64.t = {
    var i:W64.t;
  ...
  proc nbytes_copy_offset_pk____memcpy_u8u8_3 (out:W8.t Array64.t,
                                               in_0:W8.t Array32.t,
                                               out_offset:W64.t, bytes:int) : 
  W8.t Array64.t = {
    var inc:int;
  ...
  proc nbytes_copy_offset_sk____nbytes_copy_offset (out:W8.t Array131.t,
                                                    offset_out:W64.t,
                                                    in_0:W8.t Array32.t,
                                                    offset_in:W64.t) : 
  W8.t Array131.t = {
  ...
  proc nbytes_copy_offset_sk____memcpy_u8u8 (out:W8.t Array131.t,
                                             in_0:W8.t Array32.t) : W8.t Array131.t = {
    var i:W64.t;
    i <- (W64.of_int 0);
    while ((i \ult (W64.of_int 32))) {
      out.[(W64.to_uint i)] <- in_0.[(W64.to_uint i)];
  ...
  proc nbytes_copy_offset_sk___memcpy_u8u8 (out:W8.t Array131.t,
                                            in_0:W8.t Array32.t) : W8.t Array131.t = {
    
    out <@ nbytes_copy_offset_sk____memcpy_u8u8 (out, in_0);
    return out;
  }
  proc nbytes_copy_offset_sk___x_memcpy_u8u8 (out:W8.t Array131.t,
                                              in_0:W8.t Array32.t) : 
  W8.t Array131.t = {
    
    out <- out;
    in_0 <- in_0;
    out <@ nbytes_copy_offset_sk___memcpy_u8u8 (out, in_0);
    out <- out;
    return out;
  }
  proc nbytes_copy_offset_sk____memcpy_u8u8_2 (out:W8.t Array131.t,
                                               in_0:W8.t Array32.t,
                                               in_offset:W64.t, bytes:W64.t) : 
  ...
  proc nbytes_copy_offset_sk____memcpy_u8u8_3 (out:W8.t Array131.t,
                                               in_0:W8.t Array32.t,
                                               out_offset:W64.t, bytes:int) : 
  W8.t Array131.t = {
    var inc:int;
  ...
  proc copy_nbytes (out:W8.t Array32.t, in_0:W8.t Array32.t) : W8.t Array32.t = {
    var i:W64.t;
    if ((32 = 32)) {
      out <-
      (Array32.init
      (WArray32.get8
      (WArray32.set64 (WArray32.init8 (fun i_0 => out.[i_0])) 0
      (get64_direct (WArray32.init8 (fun i_0 => in_0.[i_0])) 0))));
      out <-
      (Array32.init
      (WArray32.get8
      (WArray32.set64 (WArray32.init8 (fun i_0 => out.[i_0])) 1
      (get64_direct (WArray32.init8 (fun i_0 => in_0.[i_0])) (1 * 8)))));
      out <-
      (Array32.init
      (WArray32.get8
      (WArray32.set64 (WArray32.init8 (fun i_0 => out.[i_0])) 2
      (get64_direct (WArray32.init8 (fun i_0 => in_0.[i_0])) (2 * 8)))));
      out <-
      (Array32.init
      (WArray32.get8
      (WArray32.set64 (WArray32.init8 (fun i_0 => out.[i_0])) 3
      (get64_direct (WArray32.init8 (fun i_0 => in_0.[i_0])) (3 * 8)))));
    } else {
      i <- (W64.of_int 0);
      while ((i \ult (W64.of_int 32))) {
        out.[(W64.to_uint i)] <- in_0.[(W64.to_uint i)];
  ...
  proc copy_nbytes_unaligned_left (out:W8.t Array32.t, in_0:W8.t Array32.t) : 
  W8.t Array32.t = {
    var i:W64.t;
    if ((32 = 32)) {
      out <-
      ...
      (WArray32.get8
      (WArray32.set64_direct (WArray32.init8 (fun i_0 => out.[i_0])) 
      (0 * 8) (get64 (WArray32.init8 (fun i_0 => in_0.[i_0])) 0))));
      out <-
      (Array32.init
      (WArray32.get8
      (WArray32.set64_direct (WArray32.init8 (fun i_0 => out.[i_0])) 
      (1 * 8) (get64 (WArray32.init8 (fun i_0 => in_0.[i_0])) 1))));
      out <-
      (Array32.init
      (WArray32.get8
      (WArray32.set64_direct (WArray32.init8 (fun i_0 => out.[i_0])) 
      (2 * 8) (get64 (WArray32.init8 (fun i_0 => in_0.[i_0])) 2))));
      out <-
      (Array32.init
      (WArray32.get8
      (WArray32.set64_direct (WArray32.init8 (fun i_0 => out.[i_0])) 
      (3 * 8) (get64 (WArray32.init8 (fun i_0 => in_0.[i_0])) 3))));
    } else {
      i <- (W64.of_int 0);
      while ((i \ult (W64.of_int 32))) {
        out.[(W64.to_uint i)] <- in_0.[(W64.to_uint i)];
  ...
  proc copy_nbytes_from_ptr (out_ptr:W64.t, offset:W64.t, in_0:W8.t Array32.t) : 
  W64.t = {
    var i:W64.t;
    var i_0:int;
    if (((32 = 32) /\ (32 = 32))) {
      ...
      while ((i_0 < 4)) {
        Glob.mem <-
        (storeW64 Glob.mem
        (W64.to_uint ((out_ptr + offset) + (W64.of_int (8 * i_0))))
        (get64_direct (WArray32.init8 (fun i_1 => in_0.[i_1])) (8 * i_0)));
        i_0 <- (i_0 + 1);
      }
    } else {
      i <- (W64.of_int 0);
      while ((i \ult (W64.of_int 32))) {
        Glob.mem <-
        (storeW8 Glob.mem (W64.to_uint (out_ptr + offset))
        in_0.[(W64.to_uint i)]);
        offset <- (offset + (W64.of_int 1));
        i <- (i + (W64.of_int 1));
      }
  ...
  proc _zero_address (addr:W32.t Array8.t) : W32.t Array8.t = {
    ...
    while ((i < 4)) {
      ...
      (Array8.init
      (WArray32.get32
      (WArray32.set64 (WArray32.init32 (fun i_0 => addr.[i_0])) i
      (W64.of_int 0))));
      i <- (i + 1);
    }
    return addr;
  ...
  W32.t Array8.t = {
    ...
    (Array8.init
    (WArray32.get32
    (WArray32.set64 (WArray32.init32 (fun i => out.[i])) 0
    (get64 (WArray32.init32 (fun i => in_0.[i])) 0))));
    out.[2] <- in_0.[2];
    return out;
  }
  ...
  proc __store_ref_array (out:W8.t Array32.t, h:W32.t Array8.t) : W8.t Array32.t = {
    ...
    while ((i < 8)) {
      ...
      (Array32.init
      (WArray32.get8
      (WArray32.set32_direct (WArray32.init8 (fun i_0 => out.[i_0])) 
      (4 * i) v)));
      i <- (i + 1);
    }
    return out;
  ...
  W8.t Array32.t = {
    var aux_0:W32.t Array32.t;
    var aux:W32.t Array8.t;
    var bits:W64.t;
    var h:W32.t Array8.t;
    var hp:W32.t Array8.t;
    var sblocks:W32.t Array32.t;
    ...
    sblocksp <- sblocks;
    (aux, aux_0) <@ _blocks_1_ref (hp, sblocksp, nblocks);
    hp <- aux;
     _0 <-
    (Array128.init
    (fun i => (get8 (WArray128.init32 (fun i => aux_0.[i])) i)));
    (* Erased call to unspill *)
    h <- hp;
    out <@ __store_ref_array (out, h);
    return out;
  }
  proc hash_plen_n_32___blocks_0_ref_array (_H:W32.t Array8.t,
                                            in_0:W8.t Array96.t) : W32.t Array8.t *
                                                                   W64.t = {
    var offset:W64.t;
    var inlen:W64.t;
    var kp:W32.t Array64.t;
  ...
  proc hash_plen_n_32____lastblocks_ref_array (in_0:W8.t Array96.t,
                                               inlen:W64.t, offset:W64.t,
                                               bits:W64.t) : W32.t Array32.t *
                                                             W64.t = {
    var sblocks:W32.t Array32.t;
    var nblocks:W64.t;
    var i:W64.t;
  ...
  proc hash_plen_n_32____sha256 (out:W8.t Array32.t, in_0:W8.t Array96.t) : 
  W8.t Array32.t = {
    var aux_0:W32.t Array32.t;
    var aux:W32.t Array8.t;
    var bits:W64.t;
    ...
    sblocksp <- witness;
    (* Erased call to spill *)
    bits <- (W64.of_int ((32 + 32) + 32));
    bits <- (bits `<<` (W8.of_int 3));
    (* Erased call to spill *)
    h <@ __initH_ref ();
    (* Erased call to spill *)
    hp <- h;
    (hp, offset) <@ hash_plen_n_32___blocks_0_ref_array (hp, in_0);
    (* Erased call to unspill *)
    inlen <- (W64.of_int (((32 + 32) + 32) %% 64));
    (sblocks, nblocks) <@ hash_plen_n_32____lastblocks_ref_array (in_0,
    inlen, offset, bits);
    sblocksp <- sblocks;
    (aux, aux_0) <@ _blocks_1_ref (hp, sblocksp, nblocks);
    hp <- aux;
  ...
  proc hash_plen_2n_32___blocks_0_ref_array (_H:W32.t Array8.t,
                                             in_0:W8.t Array128.t) : 
  ...
  proc hash_plen_2n_32____lastblocks_ref_array (in_0:W8.t Array128.t,
                                                inlen:W64.t, offset:W64.t,
                                                bits:W64.t) : W32.t Array32.t *
                                                              W64.t = {
    var sblocks:W32.t Array32.t;
  ...
  proc hash_plen_2n_32____sha256 (out:W8.t Array32.t, in_0:W8.t Array128.t) : 
  W8.t Array32.t = {
    var aux_0:W32.t Array32.t;
    var aux:W32.t Array8.t;
    var bits:W64.t;
    ...
    sblocksp <- witness;
    (* Erased call to spill *)
    bits <- (W64.of_int ((32 + (2 * 32)) + 32));
    bits <- (bits `<<` (W8.of_int 3));
    (* Erased call to spill *)
    h <@ __initH_ref ();
    (* Erased call to spill *)
    hp <- h;
    (hp, offset) <@ hash_plen_2n_32___blocks_0_ref_array (hp, in_0);
    (* Erased call to unspill *)
    inlen <- (W64.of_int (((32 + (2 * 32)) + 32) %% 64));
    (sblocks, nblocks) <@ hash_plen_2n_32____lastblocks_ref_array (in_0,
    inlen, offset, bits);
    sblocksp <- sblocks;
    (aux, aux_0) <@ _blocks_1_ref (hp, sblocksp, nblocks);
    hp <- aux;
  ...
  proc hash_plen_2n___blocks_0_ref_array (_H:W32.t Array8.t,
                                          in_0:W8.t Array96.t) : W32.t Array8.t *
                                                                 W64.t = {
    var offset:W64.t;
    var inlen:W64.t;
  ...
  proc hash_plen_2n____lastblocks_ref_array (in_0:W8.t Array96.t,
                                             inlen:W64.t, offset:W64.t,
                                             bits:W64.t) : W32.t Array32.t *
                                                           W64.t = {
    var sblocks:W32.t Array32.t;
  ...
  proc hash_plen_2n____sha256 (out:W8.t Array32.t, in_0:W8.t Array96.t) : 
  W8.t Array32.t = {
    var aux_0:W32.t Array32.t;
    var aux:W32.t Array8.t;
    var bits:W64.t;
    ...
    sblocksp <- witness;
    (* Erased call to spill *)
    bits <- (W64.of_int (32 + (2 * 32)));
    bits <- (bits `<<` (W8.of_int 3));
    (* Erased call to spill *)
    h <@ __initH_ref ();
    (* Erased call to spill *)
    hp <- h;
    (hp, offset) <@ hash_plen_2n___blocks_0_ref_array (hp, in_0);
    (* Erased call to unspill *)
    inlen <- (W64.of_int ((32 + (2 * 32)) %% 64));
    (sblocks, nblocks) <@ hash_plen_2n____lastblocks_ref_array (in_0, 
    inlen, offset, bits);
    sblocksp <- sblocks;
    (aux, aux_0) <@ _blocks_1_ref (hp, sblocksp, nblocks);
    hp <- aux;
  ...
  proc hash_plen_3n___blocks_0_ref_array (_H:W32.t Array8.t,
                                          in_0:W8.t Array128.t) : W32.t Array8.t *
                                                                  W64.t = {
    var offset:W64.t;
    var inlen:W64.t;
    var kp:W32.t Array64.t;
  ...
  proc hash_plen_3n____lastblocks_ref_array (in_0:W8.t Array128.t,
                                             inlen:W64.t, offset:W64.t,
                                             bits:W64.t) : W32.t Array32.t *
                                                           W64.t = {
    var sblocks:W32.t Array32.t;
  ...
  proc hash_plen_3n____sha256 (out:W8.t Array32.t, in_0:W8.t Array128.t) : 
  W8.t Array32.t = {
    var aux_0:W32.t Array32.t;
    var aux:W32.t Array8.t;
    var bits:W64.t;
    ...
    sblocksp <- witness;
    (* Erased call to spill *)
    bits <- (W64.of_int (32 + (3 * 32)));
    bits <- (bits `<<` (W8.of_int 3));
    (* Erased call to spill *)
    h <@ __initH_ref ();
    (* Erased call to spill *)
    hp <- h;
    (hp, offset) <@ hash_plen_3n___blocks_0_ref_array (hp, in_0);
    (* Erased call to unspill *)
    inlen <- (W64.of_int ((32 + (3 * 32)) %% 64));
    (sblocks, nblocks) <@ hash_plen_3n____lastblocks_ref_array (in_0, 
    inlen, offset, bits);
    sblocksp <- sblocks;
    (aux, aux_0) <@ _blocks_1_ref (hp, sblocksp, nblocks);
    hp <- aux;
  ...
  W8.t Array32.t = {
    var i:W64.t;
    var subarray_start_index:W64.t;
    var buf:W8.t Array4.t;
    buf <- witness;
    i <- (W64.of_int 0);
    while ((i \ult (W64.of_int 8))) {
      subarray_start_index <- i;
      subarray_start_index <- (subarray_start_index `<<` (W8.of_int 2));
      buf <-
      (Array4.init
      (fun i_0 => addr_as_bytes.[((W64.to_uint subarray_start_index) + i_0)])
      );
      buf <@ __u32_to_bytes (buf, addr.[(W64.to_uint i)]);
      addr_as_bytes <-
      (Array32.init
      (fun i_0 => (if ((W64.to_uint subarray_start_index) <= i_0 < ((
                                                                    W64.to_uint
                                                                    subarray_start_index
                                                                    ) +
                                                                   4)) then 
                  buf.[(i_0 - (W64.to_uint subarray_start_index))] else 
                  addr_as_bytes.[i_0]))
      );
      i <- (i + (W64.of_int 1));
    }
  ...
  W8.t Array32.t = {
    ...
    padding_buf <@ bytes_pad__ull_to_bytes (padding_buf, (W64.of_int 3));
    buf <-
    (Array96.init
    (fun i => (if (0 <= i < (0 + 32)) then padding_buf.[(i - 0)] else 
              buf.[i]))
    );
    aux <@ copy_nbytes ((Array32.init (fun i => buf.[(32 + i)])), key);
    buf <-
    (Array96.init
    (fun i => (if (32 <= i < (32 + 32)) then aux.[(i - 32)] else buf.[i])));
    buf <-
    (Array96.init
    (fun i => (if ((32 + 32) <= i < ((32 + 32) + 32)) then (Array32.init
                                                           (fun i => 
                                                           (get8
                                                           (WArray32.init64
                                                           (fun i => 
    ...
    if ((32 = 32)) {
      out <@ hash_plen_2n____sha256 (out, buf);
    } else {
      out <@ hash_plen_n_32____sha256 (out, buf);
    }
    return out;
  }
  ...
  proc __prf_keygen (out:W8.t Array32.t, in_0:W8.t Array64.t,
    ...
    padding_buf <- witness;
    padding_buf <- (Array32.init (fun i => buf.[(0 + i)]));
    padding_buf <@ bytes_pad__ull_to_bytes (padding_buf, (W64.of_int 4));
    buf <-
    (Array128.init
    (fun i => (if (0 <= i < (0 + 32)) then padding_buf.[(i - 0)] else 
              buf.[i]))
    ...
    if ((32 = 32)) {
      ...
      buf <-
      (Array128.init
      (fun i => (if (32 <= i < (32 + 32)) then (copy_8 key).[(i - 32)] else 
                buf.[i]))
      );
    }
    buf <-
    (Array128.init
    (fun i => (if ((32 + 32) <= i < ((32 + 32) + 64)) then (Array64.init
                                                           (fun i => 
                                                           (get8
                                                           (WArray64.init64
                                                           (fun i => 
    ...
    if ((32 = 32)) {
      out <@ hash_plen_3n____sha256 (out, buf);
    } else {
      out <@ hash_plen_2n_32____sha256 (out, buf);
    }
    return out;
  }
  ...
  proc __hash_message (mhash:W8.t Array32.t, r:W8.t Array32.t,
    ...
    buf <- witness;
    buf_n <- witness;
    buf <@ bytes_pad__ull_to_bytes (buf, (W64.of_int 2));
    offset <- 0;
    m_with_prefix_ptr <@ memcpy_u8pu8_plen___x_memcpy_u8pu8 (m_with_prefix_ptr,
    0, buf);
    offset <- 32;
    m_with_prefix_ptr <@ copy_nbytes_from_ptr (m_with_prefix_ptr,
    (W64.of_int offset), r);
    offset <- (32 + 32);
    m_with_prefix_ptr <@ copy_nbytes_from_ptr (m_with_prefix_ptr,
    (W64.of_int offset), root);
    buf_n <@ bytes_n__ull_to_bytes (buf_n, idx);
    offset <- (32 + (2 * 32));
    m_with_prefix_ptr <@ memcpy_u8pu8_n___x_memcpy_u8pu8 (m_with_prefix_ptr,
    offset, buf_n);
    len <- mlen;
  ...
  proc __thash_h (out:W8.t Array32.t, in_0:W8.t Array64.t,
    ...
    bitmask <- witness;
    buf <- witness;
    aux <@ bytes_pad__ull_to_bytes ((Array32.init
                                    (fun i_0 => buf.[(0 + i_0)])),
    (W64.of_int 1));
    buf <-
    (Array128.init
    ...
    if (((32 = 32) /\ (32 = 32))) {
      ...
      while ((i \ult (W64.of_int 8))) {
        t_0 <-
        (get64_direct (WArray64.init8 (fun i_0 => in_0.[i_0]))
        (W64.to_uint ((W64.of_int 8) * i)));
        t_0 <-
        (t_0 `^`
        (get64 (WArray64.init8 (fun i_0 => bitmask.[i_0])) (W64.to_uint i)));
        buf <-
        (Array128.init
        (WArray128.get8
        (WArray128.set64 (WArray128.init8 (fun i_0 => buf.[i_0]))
        (W64.to_uint ((W64.of_int 8) + i)) t_0)));
        i <- (i + (W64.of_int 1));
      }
    } else {
      i <- (W64.of_int 0);
  ...
  proc __thash_f (out:W8.t Array32.t, pub_seed:W8.t Array32.t,
    ...
    padding <@ bytes_pad__ull_to_bytes (padding, (W64.of_int 0));
    buf <-
    (Array96.init
    ...
    if (((32 = 32) /\ (32 = 32))) {
      ...
      while ((i \ult (W64.of_int 4))) {
        t_0 <-
        (get64_direct (WArray32.init8 (fun i_0 => out.[i_0]))
        (W64.to_uint ((W64.of_int 8) * i)));
        t_0 <-
        (t_0 `^`
        (get64 (WArray32.init8 (fun i_0 => bitmask.[i_0])) (W64.to_uint i)));
        buf <-
        (Array96.init
        (WArray96.get8
        (WArray96.set64 (WArray96.init8 (fun i_0 => buf.[i_0]))
        (W64.to_uint ((W64.of_int 8) + i)) t_0)));
        i <- (i + (W64.of_int 1));
      }
    } else {
  ...
  proc basew_checksum____base_w (output:W32.t Array3.t, input:W8.t Array2.t) : 
  W32.t Array3.t = {
    var in_0:W64.t;
    var out:W64.t;
    var bits:W64.t;
    ...
    out <- (W64.of_int 0);
    bits <- (W64.of_int 0);
    consumed <- (W8.of_int 0);
    total <- (W8.of_int 0);
    while ((consumed \ult (W8.of_int 3))) {
      ...
      consumed <- (consumed + (W8.of_int 1));
    }
    return output;
  }
  proc basew_chain_lengths____base_w (output:W32.t Array64.t,
                                      input:W8.t Array32.t) : W32.t Array64.t = {
    var in_0:W64.t;
    var out:W64.t;
    var bits:W64.t;
    var consumed:W8.t;
    ...
    consumed <- (W8.of_int 0);
    total <- (W8.of_int 0);
    while ((consumed \ult (W8.of_int 64))) {
      if ((bits = (W64.of_int 0))) {
        total <- input.[(W64.to_uint in_0)];
        in_0 <- (in_0 + (W64.of_int 1));
        bits <- (bits + (W64.of_int 8));
  ...
  W8.t Array2144.t * W32.t Array8.t = {
    ...
    addr <@ __set_key_and_mask (addr, (W32.of_int 0));
    aux <@ copy_nbytes ((Array32.init (fun i_0 => buf.[(0 + i_0)])),
    pub_seed);
    buf <-
    (Array64.init
    (fun i_0 => (if (0 <= i_0 < (0 + 32)) then aux.[(i_0 - 0)] else buf.[i_0]))
    ...
    while ((i \ult (W64.of_int 67))) {
      ...
      if ((32 = 32)) {
        subarray_start_index <- i;
        subarray_start_index <- (subarray_start_index `<<` (W8.of_int 5));
      } else {
        subarray_start_index <- i;
        subarray_start_index <- (subarray_start_index * (W64.of_int 32));
      }
      ith_seed <-
      (Array32.init
      (fun i_0 => outseeds.[((W64.to_uint subarray_start_index) + i_0)]));
      ...
      (fun i_0 => (if ((W64.to_uint subarray_start_index) <= i_0 < ((
                                                                   ...
                                                                   32)) then 
                  ith_seed.[(i_0 - (W64.to_uint subarray_start_index))] else 
                  outseeds.[i_0]))
      );
      (* Erased call to spill *)
      (* Erased call to unspill *)
  ...
  proc __wots_checksum (csum_base_w:W32.t Array3.t,
    ...
    csum_bytes_p <@ bytes_wots_checksum__ull_to_bytes (csum_bytes_p, csum);
    csum_base_w <@ basew_checksum____base_w (csum_base_w, csum_bytes_p);
    return csum_base_w;
  }
  ...
  W32.t Array67.t = {
    ...
    t0 <@ basew_chain_lengths____base_w (t0, msg);
    lengths <-
    (Array67.init
  ...
  W8.t Array2144.t * W32.t Array8.t = {
    ...
    while ((i \ult (W64.of_int 67))) {
      ...
      t <-
      (Array32.init
      (fun i_0 => pk.[((W64.to_uint subarray_start_index) + i_0)]));
      ...
      (fun i_0 => (if ((W64.to_uint subarray_start_index) <= i_0 < ((
                                                                   ...
                                                                   32)) then 
                  t.[(i_0 - (W64.to_uint subarray_start_index))] else 
                  pk.[i_0]))
      );
      (* Erased call to spill *)
      i <- (i + (W64.of_int 1));
  ...
  proc __wots_sign (sig:W8.t Array2144.t, msg:W8.t Array32.t,
    ...
    while ((i \ult (W64.of_int 67))) {
      ...
      (* Erased call to spill *)
      (* Erased call to unspill *)
      (aux, aux_0) <@ __gen_chain_inplace_ ((Array32.init
                                            (fun i_0 => sig.[((W64.to_uint
                                                              subarray_start_index
                                                              ) +
                                                             i_0)])
                                            ),
      (W32.of_int 0), lengths.[(W64.to_uint i)], pub_seed, addr);
      sig <-
      (Array2144.init
      (fun i_0 => (if ((W64.to_uint subarray_start_index) <= i_0 < ((
                                                                    W64.to_uint
                                                                   ...
                                                                   32)) then 
                  aux.[(i_0 - (W64.to_uint subarray_start_index))] else 
                  sig.[i_0]))
      );
      addr <- aux_0;
      (* Erased call to unspill *)
  ...
  proc __wots_pk_from_sig (pk:W8.t Array2144.t, sig_ptr:W64.t,
    ...
    while ((i \ult (W64.of_int 67))) {
      chain_addr <- (truncateu32 i);
      addr <@ __set_chain_addr (addr, chain_addr);
      start <- lengths.[(W64.to_uint i)];
      steps <- (W32.of_int (16 - 1));
      steps <- (steps - lengths.[(W64.to_uint i)]);
      if ((32 = 32)) {
        subarray_start_index <- i;
        subarray_start_index <- (subarray_start_index `<<` (W8.of_int 5));
      } else {
      ...
      (* Erased call to unspill *)
      t <- sig_ptr;
      t <- (t + subarray_start_index);
      aux <@ __memcpy_u8u8p ((Array32.init
                             (fun i_0 => pk.[((W64.to_uint
                                              subarray_start_index) +
                                             i_0)])
                             ),
      t);
      ...
      (aux, aux_0) <@ _gen_chain_inplace ((Array32.init
                                          (fun i_0 => pk.[((W64.to_uint
                                                           subarray_start_index
                                                           ) +
                                                          i_0)])
  ...
  proc __l_tree (leaf:W8.t Array32.t, wots_pk:W8.t Array2144.t,
    ...
    while (((W64.of_int 1) \ult l)) {
      parent_nodes <- l;
      parent_nodes <- (parent_nodes `>>` (W8.of_int 1));
      (* Erased call to spill *)
      i <- (W64.of_int 0);
      while ((i \ult parent_nodes)) {
        ...
        if ((32 = 32)) {
          offset_in <- i;
          offset_in <- (offset_in `<<` (W8.of_int 6));
        } else {
        ...
        (* Erased call to unspill *)
        (buf1,  _0) <@ memcpy_u8u8_2_ltree____memcpy_u8u8_2 (buf1, wots_pk,
        offset_in, bytes);
        (* Erased call to unspill *)
        ...
        if ((32 = 32)) {
          offset_out <- i;
          offset_out <- (offset_out `<<` (W8.of_int 5));
        } else {
      ...
      if ((t <> (W64.of_int 0))) {
        ...
        if ((32 = 32)) {
          ...
          offset_in <- (offset_in `<<` (W8.of_int 5));
          offset_out <- l;
          offset_out <- (offset_out `>>` (W8.of_int 1));
          offset_out <- (offset_out `<<` (W8.of_int 5));
        } else {
          offset_out <- l;
          offset_out <- (offset_out `>>` (W8.of_int 1));
    ...
    leaf <@ memcpy_u8u8_N___x_memcpy_u8u8 (leaf, tmp);
  ...
  W8.t Array32.t * W32.t Array8.t = {
    ...
    (* Erased call to spill *)
    k <- (W64.of_int 0);
    while ((k \ult (W64.of_int 10))) {
      (* Erased call to spill *)
      tree_height <- (truncateu32 k);
      ...
      u <- tree_height;
      u <- (u + (W32.of_int 1));
      t <- (t `>>` (truncateu8 (u `&` (W32.of_int 31))));
      addr <@ __set_tree_index (addr, t);
      tree_height <- tree_height;
      t <- leaf_idx;
      t <- (t `>>` (truncateu8 (tree_height `&` (W32.of_int 31))));
      t <- (t `&` (W32.of_int 1));
      if ((t = (W32.of_int 0))) {
        if ((k = (W64.of_int 0))) {
          thash_in <-
        ...
        offset <- k;
        if ((32 = 32)) {
          offset <- (offset `<<` (W8.of_int 5));
        } else {
          offset <- (offset * (W64.of_int 32));
        }
        _ptr <- _auth_path_ptr;
        _ptr <- (_ptr + offset);
        aux <@ _x_memcpy_u8u8p ((Array32.init (fun i => thash_in.[(32 + i)])),
        _ptr);
        thash_in <-
        (Array64.init
        (fun i => (if (32 <= i < (32 + 32)) then aux.[(i - 32)] else 
                  thash_in.[i]))
        );
      } else {
        if ((k = (W64.of_int 0))) {
        ...
        _ptr <- _auth_path_ptr;
        _ptr <- (_ptr + offset);
        aux <@ _x_memcpy_u8u8p ((Array32.init (fun i => thash_in.[(0 + i)])),
        _ptr);
        thash_in <-
        (Array64.init
        (fun i => (if (0 <= i < (0 + 32)) then aux.[(i - 0)] else thash_in.[
                                                                  i]))
        );
      }
      (* Erased call to unspill *)
      if ((k = (W64.of_int (10 - 1)))) {
        (* Erased call to unspill *)
  ...
  proc __set_result (are_equal:W8.t, m_ptr:W64.t, mlen_ptr:W64.t,
    ...
    if ((are_equal <> (W8.of_int 0))) {
      res_0 <- (W64.of_int (- 1));
      bytes <- (loadW64 Glob.mem (W64.to_uint mlen_ptr));
      __memset_u8_ptr (m_ptr, bytes, (W8.of_int 0));
      Glob.mem <- (storeW64 Glob.mem (W64.to_uint mlen_ptr) (W64.of_int 0));
    } else {
      res_0 <- (W64.of_int 0);
      bytes <- (loadW64 Glob.mem (W64.to_uint mlen_ptr));
      offset_in <- sm_offset;
  ...
  proc __xmssmt_core_sign_open (m_ptr:W64.t, mlen_ptr:W64.t, sm_ptr:W64.t,
    ...
    Glob.mem <- (storeW64 Glob.mem (W64.to_uint mlen_ptr) t64);
    idx <@ __bytes_to_ull_ptr (sm_ptr);
    (* Erased call to spill *)
    bytes <- (loadW64 Glob.mem (W64.to_uint mlen_ptr));
    _x__memcpy_u8pu8p (m_ptr, (W64.of_int 4963), sm_ptr, (W64.of_int 4963),
    bytes);
    t64 <- sm_ptr;
    ...
    while ((i \ult (W32.of_int 2))) {
      ...
      t64 <- (t64 + sm_offset);
      root <- root;
      (wots_pk, ots_addr) <@ __wots_pk_from_sig (wots_pk, t64, root,
      pub_seed, ots_addr);
      t64 <- sm_offset;
  ...
  W8.t Array32.t = {
    ...
    while ((i \ult upper_bound)) {
      ...
      _stack <@ memcpy_u8u8_3_treehash____memcpy_u8u8_3 (_stack, buf, 
      t64, 32);
      (* Erased call to unspill *)
      offset <- (offset + (W64.of_int 1));
      ...
      while ((cond = (W8.of_int 1))) {
        ...
        (* Erased call to spill *)
        (buf2,  _0) <@ memcpy_u8u8_2_treehash____memcpy_u8u8_2 (buf2, 
        _stack, t64, (W64.of_int (2 * 32)));
        (* Erased call to unspill *)
    ...
    if (((32 %% 8) = 0)) {
      ...
      while ((j < inc)) {
        ...
        (Array32.init
        (WArray32.get8
        (WArray32.set64_direct (WArray32.init8 (fun i_0 => root.[i_0]))
        (8 * j) (get64 (WArray352.init8 (fun i_0 => _stack.[i_0])) j))));
        j <- (j + 1);
      }
    } else {
      j <- 0;
  ...
  proc __build_auth_path (auth_path:W8.t Array320.t, sk_seed:W8.t Array32.t,
    ...
    (* Erased call to spill *)
    j <- (W64.of_int 0);
    while ((j \ult (W64.of_int 10))) {
      (* Erased call to unspill *)
      (* Erased call to spill *)
      k <- (zeroextu64 i);
      k <- (k `>>` (truncateu8 (j `&` (W64.of_int 63))));
      k <- (k `^` (W64.of_int 1));
      k <- (k `<<` (truncateu8 (j `&` (W64.of_int 63))));
      (* Erased call to unspill *)
      if ((32 = 32)) {
      ...
      j32 <- (truncateu32 j);
      k32 <- (truncateu32 k);
      aux <@ __treehash ((Array32.init
                         (fun i_0 => auth_path.[((W64.to_uint
                                                 subarray_start_index) +
                                                i_0)])
                         ),
      sk_seed, pub_seed, k32, j32, addr);
      auth_path <-
      (Array320.init
      (fun i_0 => (if ((W64.to_uint subarray_start_index) <= i_0 < ((
                                                                    W64.to_uint
  ...
  W8.t Array2464.t * W32.t Array8.t = {
    ...
    sig_ots <- witness;
    sk_seed <- witness;
    sig_ots <- (Array2144.init (fun i => sig.[(0 + i)]));
    auth_path <- (Array320.init (fun i => sig.[(2144 + i)]));
    pub_seed <- (Array32.init (fun i => sk.[((3 + (3 * 32)) + i)]));
    sk_seed <- (Array32.init (fun i => sk.[(3 + i)]));
    addr.[4] <- (W32.of_int 0);
    (* Erased call to spill *)
    ...
    sig <-
    (Array2464.init
    (fun i => (if (0 <= i < (0 + 2144)) then sig_ots.[(i - 0)] else sig.[i]))
    );
    sig <-
    (Array2464.init
    (fun i => (if (2144 <= i < (2144 + 320)) then auth_path.[(i - 2144)] else 
              sig.[i]))
    );
    return (sig, addr);
  }
  ...
  proc __xmssmt_core_seed_keypair (pk:W8.t Array64.t, sk:W8.t Array131.t,
    ...
    (* Erased call to spill *)
    root <@ __treehash (root, bufn0, bufn1, (W32.of_int 0), (W32.of_int 10),
    top_tree_addr);
    (* Erased call to unspill *)
    pk <@ nbytes_copy_offset_pk____nbytes_copy_offset (pk, (W64.of_int 0),
    root, (W64.of_int 0));
    sk <@ nbytes_copy_offset_sk____nbytes_copy_offset (sk,
    (W64.of_int (3 + (2 * 32))), root, (W64.of_int 0));
    return (pk, sk);
  }
  ...
  proc __xmssmt_core_sign (sk:W8.t Array131.t, sm_ptr:W64.t, smlen_ptr:W64.t,
    ...
    t64 <- mlen;
    t64 <- (t64 + (W64.of_int 4963));
    Glob.mem <- (storeW64 Glob.mem (W64.to_uint smlen_ptr) t64);
    (* Erased call to spill *)
    idx_bytes <- (Array3.init (fun i_0 => sk.[(0 + i_0)]));
    idx <@ __bytes_to_ull (idx_bytes);
    if (((W64.of_int ((1 `<<` 20) - 1)) \ule idx)) {
      idx_bytes <@ memset_idx_bytes____memset_u8 (idx_bytes,
      (W8.of_int 255));
      sk <-
      (Array131.init
      ...
      aux <@ memset_i____memset_u8 ((Array128.init
                                    (fun i_0 => sk.[(3 + i_0)])),
      (W8.of_int 0));
      sk <-
      (Array131.init
    ...
    if ((exit_0 <> (W8.of_int 1))) {
      ...
      aux_0 <@ bytes_idx__ull_to_bytes ((Array3.init
                                        (fun i_0 => sk.[(0 + i_0)])),
      t64);
      sk <-
      (Array131.init
      ...
      (* Erased call to spill *)
      index_bytes <@ bytes_32__ull_to_bytes (index_bytes, idx);
      ...
      while ((i \ult (W64.of_int 2))) {
        ...
        (* Erased call to spill *)
        (* Erased call to unspill *)
        layer_addr <- (truncateu32 i);
        ots_addr <@ __set_layer_addr (ots_addr, layer_addr);
        ots_addr <@ __set_tree_addr (ots_addr, idx_tree);
        subarray_start_index <- i;
        subarray_start_index <- (subarray_start_index * (W64.of_int 2464));
        subarray_start_index <-
        (subarray_start_index + (W64.of_int (3 + 32)));
        (* Erased call to unspill *)
        (aux_1, aux_2) <@ __tree_sig_ ((Array2464.init
                                       (fun i_0 => signature.[((W64.to_uint
                                                               subarray_start_index
                                                               ) +
                                                              i_0)])
                                       ),
        ...
        (Array4963.init
        (fun i_0 => (if ((W64.to_uint subarray_start_index) <= i_0 < 
                        ((W64.to_uint subarray_start_index) + 2464)) then 
                    aux_1.[(i_0 - (W64.to_uint subarray_start_index))] else 
                    signature.[i_0]))
        );
        ots_addr <- aux_2;
        (* Erased call to unspill *)
      ...
      while ((j < 4963)) {
        Glob.mem <-
        (storeW8 Glob.mem (W64.to_uint (sm_ptr + (W64.of_int j)))
        signature.[j]);
        j <- (j + 1);
      }
